...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "386479956".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rus.910808.xyz"];
pub const RS_PUB_KEY: &str = "dIywnCS0SaMgWayUiVRtzsO0si55zqkSBMDCVw1VRkw=";
