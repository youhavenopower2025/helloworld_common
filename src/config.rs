...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "Unitcd123".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["222.209.208.56"];
pub const RS_PUB_KEY: &str = "05wGZeXjLh5DaO1Jaz1qlOTfLaYLBDmJWuqDwNpgZNw=";
