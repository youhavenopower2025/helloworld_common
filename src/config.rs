...
lazy_static::lazy_static! {
    ...
    pub static ref OVERWRITE_LOCAL_SETTINGS: RwLock<HashMap<String, String>> = Default::default();
     pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "SCV2@fbc4517$%t*%Xbs7".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rustdeskapi.fsveegoo.cn"];
pub const RS_PUB_KEY: &str = "BRZvhwCK4fA5I9hGcNh146HjI2LXEFs52QKqs3jg0c0=";
