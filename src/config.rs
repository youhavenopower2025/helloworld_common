...
pub const RENDEZVOUS_SERVERS: &[&str] = &["47.96.82.6"];
pub const RS_PUB_KEY: &str = "Bx11+waUEa1Z33RFc5gDfIhHmQQXgSTOyr0uLYJD6M4=";

pub const RENDEZVOUS_PORT: i32 = 17314;
pub const RELAY_PORT: i32 = 14766;
