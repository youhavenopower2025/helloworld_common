...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "147258ed".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["47.254.64.112"];
pub const RS_PUB_KEY: &str = "VMpzBXuL7w8293H3UV2NMQ7NLxjkj3WIkUoIz7HutK0=";
